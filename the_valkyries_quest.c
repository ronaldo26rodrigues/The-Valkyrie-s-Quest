...
int main(){
    ...
    while(!WindowShouldClose() && victory==false){
        ...
        switch(level){
            ...
            char texto[10][2000] = {"No inicio do mundo, nao havia nada alem do fogo e do gelo. No encontro destes dois elementos, surgiu a nevoa primordial,\n\no Ginnungagap, e dela surgiu Ymir, o primeiro gigante, que daria origem para as duas racas: A raca dos Gigantes e os\n\nprimeiros grandes Deuses.Por estarem em constante conflito, os Deuses acabam assassinando Ymir, dando origem aos mundos.\n\nA arvore da vida era a responsavel por portar os nove mundos, os Deuses se dividiram em dois clas, os responsaveis pela guerra\n\n,Aesir, habitantes de Asgard, liderados por Bor, que passou este cargo para seu filho Odin, e infelizmente nao passara para Thor,\n\n pois sua morte ja esta escrita, os responsaveis pela Natureza, Vanir, habitantes de Vanaheim liderados por Frey e Freya,\n\n Deuses do verao e da primavera.\n\nA vida entao se espalhou por todos os nove mundos, e como toda grande historia, escrita em sangue, morte e heroismo.\n\n Midgard ate os dias atuais se perde em guerra, Alfheim, mundo dos elfos, perdeu-se em sua propria soberba, Nidavellir,\n\n o mundo dos anoes, e assolado pelos elfos negros, Jotunheim, o mundo dos gigantes, e uma prisao de constante conflito e situacoes\n\nextremas e Muspelheim, o mundo dos gigantes de fogo e um literal inferno, alem dos reinos inalcancaveis.\n\nToda vida tem seu peso, e esse peso e medido, aqueles que morrem de maneira desonrosa caem nos pocos de Helheim, cumprindo\n\nsua sentenca para Hela, a Deusa da morte, e aqueles que morrem de maneira honrada, ganham a Bencao de ir para Valhalla,\n\no salao dos Deuses, onde herois comem, bebem, festejam e digladiam ate o fim.\n\n","E existem aquelas responsaveis por dar a cada pessoa um destino apos a morte digno, as Valquirias, guerreiras escolhidas\n\npor Odin,que levam as almas dos mortos, e assim tudo funcionou por milenios...\n\nAte os dias de hoje... misteriosamente, almas de guerreiros e lendas passaram a cair de volta aos mundos dos vivos, causando\n\ncaos e atraindo monstros.\n\nEm tempos de necessidade, como sempre, herois se levantam, e Odin selecionou Brunhilda, a mais forte das novas recrutas\n\npara Valquirias, responsavel por resgatar as almas, e assim conseguir sua honra em ganhar suas asas e se tornar uma\n\nverdadeira heroina\n\nOdin: Levante-se, pequena..."};
